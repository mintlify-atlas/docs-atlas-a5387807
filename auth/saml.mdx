...
**Implementation**: `io.supertokens.saml.SAML.createOrUpdateSAMLClient()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/saml/SAML.java#L121)
...
**Implementation**: `io.supertokens.saml.SAML.getClients()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/saml/SAML.java#L154)
...
**Implementation**: `io.supertokens.saml.SAML.removeSAMLClient()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/saml/SAML.java#L164)
...
**Implementation**: `io.supertokens.saml.SAML.createRedirectURL()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/saml/SAML.java#L201)
...
**Implementation**: `io.supertokens.saml.SAML.buildAuthnRequest()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/saml/SAML.java#L259)
...
**Implementation**: `io.supertokens.saml.SAML.handleCallback()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/saml/SAML.java#L417)
...
**Implementation**: `io.supertokens.saml.SAML.getUserInfo()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/saml/SAML.java#L597)
...
**Implementation**: `io.supertokens.saml.SAML.getMetadataXML()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/saml/SAML.java#L655)
...
**Implementation**: `io.supertokens.saml.SAML.verifySamlResponseSignature()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/saml/SAML.java#L363)
...
**Implementation**: `io.supertokens.saml.SAML.validateSamlResponseTimestamps()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/saml/SAML.java#L387)
...
**Implementation**: `io.supertokens.saml.SAML.validateSamlResponseAudience()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/saml/SAML.java#L497)
...
**Implementation**: `io.supertokens.saml.SAML.extractAllClaims()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/saml/SAML.java#L535)
...
**See also**: `io.supertokens.saml.SAML.buildAuthnRequest()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/saml/SAML.java#L259)
