...
TOTP is implemented in `io.supertokens.totp.Totp` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/totp/Totp.java)
...
**Implementation**: `io.supertokens.totp.Totp.registerDevice()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/totp/Totp.java#L170)
...
**Implementation**: `io.supertokens.totp.Totp.generateSecret()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/totp/Totp.java#L42)
...
**Implementation**: `io.supertokens.totp.Totp.verifyDevice()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/totp/Totp.java#L372)
...
**Implementation**: `io.supertokens.totp.Totp.verifyCode()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/totp/Totp.java#L438)
...
**Implementation**: `io.supertokens.totp.Totp.checkCode()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/totp/Totp.java#L52)
...
**Implementation**: `io.supertokens.totp.Totp.checkAndStoreCode()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/totp/Totp.java#L181)
...
**Implementation**: `io.supertokens.totp.Totp.getDevices()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/totp/Totp.java#L550)
...
**Implementation**: `io.supertokens.totp.Totp.removeDevice()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/totp/Totp.java#L485)
...
**Implementation**: `io.supertokens.totp.Totp.updateDeviceName()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/totp/Totp.java#L531)
...
**Implementation**: `io.supertokens.totp.Totp.getBulkDeviceStatus()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/totp/Totp.java#L565)
...
**Implementation**: `io.supertokens.totp.Totp.createDevices()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/totp/Totp.java#L150)
