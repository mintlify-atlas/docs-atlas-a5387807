...
The sign-up process is implemented in `io.supertokens.emailpassword.EmailPassword.signUp()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/emailpassword/EmailPassword.java#L103)
...
The sign-in process is implemented in `io.supertokens.emailpassword.EmailPassword.signIn()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/emailpassword/EmailPassword.java#L302)
...
**Implementation**: `io.supertokens.emailpassword.EmailPassword.generatePasswordResetToken()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/emailpassword/EmailPassword.java#L412)
...
**Implementation**: `io.supertokens.emailpassword.EmailPassword.consumeResetPasswordToken()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/emailpassword/EmailPassword.java#L553)
...
**Implementation**: `io.supertokens.emailpassword.EmailPassword.resetPassword()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/emailpassword/EmailPassword.java#L470)
...
**Implementation**: `io.supertokens.emailpassword.EmailPassword.updateUsersEmailOrPassword()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/emailpassword/EmailPassword.java#L641)
...
**Implementation**: `io.supertokens.emailpassword.EmailPassword.importUserWithPasswordHash()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/emailpassword/EmailPassword.java#L170)
