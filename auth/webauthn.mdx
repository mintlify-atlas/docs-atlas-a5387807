...
**Implementation**: `io.supertokens.webauthn.WebAuthN.generateRegisterOptions()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/webauthn/WebAuthN.java#L73)
...
**Implementation**: `io.supertokens.webauthn.WebAuthN.registerCredentials()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/webauthn/WebAuthN.java#L182)
...
**Implementation**: `io.supertokens.webauthn.WebAuthN.signUp()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/webauthn/WebAuthN.java#L282)
...
**Implementation**: `io.supertokens.webauthn.WebAuthN.generateSignInOptions()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/webauthn/WebAuthN.java#L139)
...
**Implementation**: `io.supertokens.webauthn.WebAuthN.signIn()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/webauthn/WebAuthN.java#L382)
...
**Implementation**: `io.supertokens.webauthn.WebAuthN.listCredentialsForUser()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/webauthn/WebAuthN.java#L615)
...
**Implementation**: `io.supertokens.webauthn.WebAuthN.loadCredentialByIdForUser()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/webauthn/WebAuthN.java#L450)
...
**Implementation**: `io.supertokens.webauthn.WebAuthN.removeCredential()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/webauthn/WebAuthN.java#L600)
...
**Implementation**: `io.supertokens.webauthn.WebAuthN.generateRecoverAccountToken()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/webauthn/WebAuthN.java#L503)
...
**Implementation**: `io.supertokens.webauthn.WebAuthN.consumeRecoverAccountToken()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/webauthn/WebAuthN.java#L533)
...
**Implementation**: `io.supertokens.webauthn.WebAuthN.updateUserEmail()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/webauthn/WebAuthN.java#L635)
...
**Implementation**: `io.supertokens.webauthn.WebAuthN.verifyRegistrationData()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/webauthn/WebAuthN.java#L217)
