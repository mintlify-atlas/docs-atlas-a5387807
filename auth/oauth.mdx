...
**Implementation**: `io.supertokens.oauth.OAuth.addOrUpdateClient()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/oauth/OAuth.java#L360)
...
**Implementation**: `io.supertokens.oauth.OAuth.doOAuthProxyFormPOST()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/oauth/OAuth.java#L114)
...
**Implementation**: `io.supertokens.oauth.OAuth.introspectAccessToken()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/oauth/OAuth.java#L510)
...
**Implementation**: `io.supertokens.oauth.OAuth.revokeRefreshToken()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/oauth/OAuth.java#L545)
...
**Implementation**: `io.supertokens.oauth.OAuth.revokeAccessToken()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/oauth/OAuth.java#L551)
...
**Implementation**: `io.supertokens.oauth.OAuth.revokeSessionHandle()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/oauth/OAuth.java#L567)
...
**Implementation**: `io.supertokens.oauth.OAuth.revokeTokensForClientId()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/oauth/OAuth.java#L539)
...
**See also**: `io.supertokens.oauth.OAuth.encryptClientSecret()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/oauth/OAuth.java#L368)
...
**Implementation**: `io.supertokens.oauth.OAuth.createLogoutRequestAndReturnRedirectUri()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/oauth/OAuth.java#L591)
...
**Implementation**: `io.supertokens.oauth.OAuth.consumeLogoutChallengeAndGetRedirectUri()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/oauth/OAuth.java#L609)
...
**See also**: `io.supertokens.oauth.OAuth.isTokenRevokedBasedOnPayload()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/oauth/OAuth.java#L498)
...
**Implementation**: `io.supertokens.oauth.OAuth.addM2MToken()` - [View source](https://github.com/supertokens/supertokens-core/blob/master/src/main/java/io/supertokens/oauth/OAuth.java#L583)
