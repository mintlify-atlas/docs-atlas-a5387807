...
**Source**: `/workspace/source/src/main/java/io/supertokens/webserver/api/userroles/AddUserRoleAPI.java:37`
...
<CardGroup cols={2}>
  <Card title="Get User Roles" href="/api/roles/get-user-roles">
    Retrieve all roles assigned to a user
  </Card>
  <Card title="Remove User Role" href="/api/roles/remove-user-role">
