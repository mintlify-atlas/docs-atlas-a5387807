...
**Source:** `/home/daytona/workspace/source/src/main/java/io/supertokens/webserver/api/core/UsersAPI.java:211-221`
...
**Source:** `/home/daytona/workspace/source/src/main/java/io/supertokens/webserver/api/core/UsersAPI.java:158`

### User ID Mapping

If user ID mapping is enabled, the response will contain external user IDs instead of internal SuperTokens IDs.

**Source:** `/home/daytona/workspace/source/src/main/java/io/supertokens/webserver/api/core/UsersAPI.java:173`
...
**Source:** `/home/daytona/workspace/source/src/main/java/io/supertokens/webserver/api/core/UsersAPI.java:180-195`
